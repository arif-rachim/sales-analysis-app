...
export default React.forwardRef(function Vertical(props: VerticalProps,ref:ForwardedRef<HTMLDivElement>): JSX.Element {
    ...
    const alignItems = hAlign === undefined ? hAlign : {left: 'flex-start', right: 'flex-end', center: 'center'}[hAlign];
    const justifyContent = vAlign === undefined ? vAlign :  {top: 'flex-start', bottom: 'flex-end', center: 'center'}[vAlign];
